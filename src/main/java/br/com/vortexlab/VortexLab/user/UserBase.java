...
public class UserBase {
  ...
  @NotBlank
  @Length(max = 50)
  @Schema(example = "imperator")
  String username;

  @Schema(description = "Razao Social of the customer", example = "Google INC")
  String razaoSocial;

  @Schema(description = "Nome Fantasia of the customer", example = "Google")
  String nomeFantasia;

  @Schema(description = "CNPJ of the customer", example = "73.345.971/0001-47")
  String cnpj;
